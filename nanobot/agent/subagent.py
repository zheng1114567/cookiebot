    ...
    async def _run_subagent(
        ...
        try:
            ...
            result = await graph.ainvoke(
                ...
                config={"recursion_limit": (15 + 5) * 3},
            )

            # Extract final content from last assistant message without tool calls
            ...
            for m in reversed(result["messages"]):
                if (
                    ...
                    final_result = m["content"]
                    break

            if final_result is None:
                final_result = result.get("error") or "Task completed but no final response was generated."
...
{self.workspace}"""]
    ...
    async def aclose(self) -> None:
        """Cancel remaining subagents and release any held resources."""
