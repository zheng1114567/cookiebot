...
If you discover a security vulnerability in cookiebot, please report it by:
...
- ✅ Run cookiebot with a dedicated user account
...
- Subscribe to security advisories for cookiebot and its dependencies
...
2. **Use a Dedicated User**
   ...
   # sudo -u cookiebot cookiebot gateway
   ```
...
- GitHub Security Advisories: https://github.com/zheng1114567/cookiebot/security/advisories
- Release Notes: https://github.com/zheng1114567/cookiebot/releases
